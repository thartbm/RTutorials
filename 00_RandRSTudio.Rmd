...
These tutorials show you similar things, but they focus on what we anticipate people will need when doing our type of research. (Although I've never really learned `tidyverse` which might be a better way to get started, but is not really used in these tutorials, sorry!) Also, these tutorials will both have you do interactive exercises and they will form a reference for you in the future, like a book.
