...
That works, but doesn't seem to change all that much (although notice that Rs is now exactly 1). It does omit the Nelder-Mead fit... maybe that can't deal with limits on parameters?
