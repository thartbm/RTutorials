...
As an example of other reasons for picking one model over another, the model above that used three parameters had multiple equally good solutions. We didn't need any statistics there to decide that the model was bad.