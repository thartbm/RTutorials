...
If there is a tie, you might use the number of function evaluations to break it (lower is better?) but that should be rare. In essence we get the same fitted circle centre as we got several times earlier. Let's see how well that circle works on all this data:
